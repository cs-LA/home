...
<p><span class="en">Whenever an intensive interval starts or ends you will hear a <i>whistle sound</i>.When the app runs in background you will get a notification combined with this <i>'whistle sound</i>. In the middle of an intensive interval you will get a notification.</span><span class="de">Zu Beginn und am Ende eines jeden intensiven Intervalls ertönt ein <i>Pfeifton</i>. In der Mitte eines intensiven Intervalls gibt es ebenfalls einen Hinweis. Wenn die App im Hintergrund läuft, erscheint ein Hinweis zusammen mit diesem <i>Pfeifton</i>.</span></p>
