...
### Ein Beispiel: Der$\mathbb{R}^n$  $\mathbf{\mathbb{R}^n}$ (bold?) mit der Definition von offenen Mengen mittels des *[euklidischen Abstands](https://de.m.wikipedia.org/wiki/Euklidischer_Abstand)*
